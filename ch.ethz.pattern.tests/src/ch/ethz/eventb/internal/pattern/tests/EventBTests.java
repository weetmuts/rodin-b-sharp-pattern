...
public abstract class EventBTests extends AbstractEventBTests {
	 ...
	 * Some variables.
	 */
	protected IVariable x;

	protected IVariable y;
	
	protected IVariable u;
	
	protected IVariable v;

	protected IVariable z;

	protected IVariable p;
	...
	protected IAction act1_2_1b_1;

	protected IAction act1_2_1b_2;
	...
	protected MatchingMachine machineMatch;
	
	protected ComplexMatching<IEvent> match_1;

	protected Matching<IGuard> match_2;

	protected Matching<IAction> match_3;
	
	protected Matching<IVariable> match_4;
	
	
	protected Matching<IVariable>[] variableMatchingArray;

	
	protected Renaming<IVariable> variableRenaming;
	
	protected Renaming<IEvent> eventRenaming;
	
	protected Renaming<IParameter> parameterRenaming;
	
	protected IParameter s;
	
	protected IParameter t;
	...
	protected void setUp() throws Exception {
		...
		//    |--  evt1_1_2 --> evt1_2_2
		//    |--  evt1_1_3 --> evt1_2_3
		machineMatch = new MatchingMachine(mch1_1, mch1_2);
		machineMatch.addComplexMatching(init1_1, init1_2, IEvent.ELEMENT_TYPE);
		machineMatch.addComplexMatching(evt1_1_2, evt1_2_2, IEvent.ELEMENT_TYPE);
		machineMatch.addComplexMatching(evt1_1_3, evt1_2_3, IEvent.ELEMENT_TYPE);
		
		// match_1:  evt_1_1_2 --> evt_1_2_2
		// match_2:   |-- grd1_1_2_1 --> grd1_2_2_1
		// match_3:   |-- act1_1_2_1 --> act1_2_2_1
		match_1 = new ComplexMatching<IEvent>(evt1_1_2, evt1_2_2,IEvent.ELEMENT_TYPE, machineMatch);
		match_2 = new Matching<IGuard>(grd1_1_2_1, grd1_2_2_1, IGuard.ELEMENT_TYPE, match_1);
		match_3 = new Matching<IAction>(act1_1_2_1, act1_2_2_1, IAction.ELEMENT_TYPE, match_1);
	
		// match_4:  x --> u
		match_4 = new Matching<IVariable>(x, u, IVariable.ELEMENT_TYPE, machineMatch);
		
		variableMatchingArray = (Matching<IVariable>[]) new Matching<?>[2];
		variableMatchingArray[0] = match_4;
		variableMatchingArray[1] = new Matching<IVariable>(y, v, IVariable.ELEMENT_TYPE, machineMatch);
		
		
		// Renamings
		
		// rename variables
		variableRenaming = new Renaming<IVariable>();
		variableRenaming.addPair(x, "x_renamed");
		variableRenaming.addPair("y", "y_renamed");
	
		// rename events
		eventRenaming = new Renaming<IEvent>();
		eventRenaming.addPair(evt1_1_3, "evt1_1_3_renamed");
		eventRenaming.addPair("evt1_3_1", "evt1_3_1_renamed");
		
		// rename parameters
		parameterRenaming = new Renaming<IParameter>();
		parameterRenaming.addPair("s", "evt1_1_3", "s_renamed");
		parameterRenaming.addPair("t", "evt1_3_3", "t_renamed");
