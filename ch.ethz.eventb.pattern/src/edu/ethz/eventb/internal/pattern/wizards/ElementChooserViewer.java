 ...
 */
public class ElementChooserViewer<T extends IRodinElement> extends ComboViewer {
	...
	private class LabelProvider implements ILabelProvider {
		...
		public String getText(Object element) {
			return PatternUtils.getDisplayText(element);
		}
	 ...
	 */
	public ElementChooserViewer(Composite container, IElementType<T> type) {
		super(container);
